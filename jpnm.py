...
datta|dayat|dorai|domi|debo|derya|dani|doo|doan|deon|deke|daan$|dat$|eu[in]|eau|eun[gk]|el|erank|engyu|ezra|eet|\
...
shikun|sarin|sumit|shaja|sen$|nen$|sek[\s$]|sacha|teoh|iang|roman|shaho|shoo|shiyu|shibo|shiha|saini|shore|shu[ioa]|sundara|shuman|saima|seo[nk]|shan|shai|shaha|sundan|s[^saueoh]|ss*h[^aiuo]|sose|\
...
Bao|Babak|Bee|Beibei|Benaim|Benjamin|Bibit|Bin|Bodo|Bojan|Boyu|Burak|Bukun|Burin|\
...
Ebuka|Edo|Erik|Ehsan|Eshaan|Eugene|Ewa|Eze|Gene|Guanyu|Gyumin|Gunawan|Ha|Haechan|Haian|Han|Hanbin|Hani|Hanna|Hannah|Hasan|He|Heiko|Henri|Hogun|Hooman|Houman|Hugo|\
Idoia|Inaki|Inkyu|Imin|Itai|Isha|Jamie|Jan|Jane|Janne|Jaron|Jason|Jaya|Jikai|Jina|Jimin|Jirak|Jose|Johan|John|Joao|Joko|Joni|Ju|Juan|Junni|Juho|Juhee|Junho|Junhyuk|\
...
Na|Naama|Nageen|Namo|Nariman|Neha|Nikita|Nima|Nirat|Noah|Nona|Nooshin|Nuno|\
Okan|Onat|Oren|Ori|Oladayo|Osama|Oya|Pere|Pouya|Pu|Ramana|Rami|Ranjan|Renshuai|Reuben|Reza|Rezaei|Rishi|Ruben|Rohit|Roi|Rosa|Ruwan|Ruhi|Ruinan|Ryan|\
Sachin|Sage|Sagie|Saket|anchari|Sanda|Saikat|Sandaru|Saman|Samit*|Samitha|Samira|Sarah|Sayan|Sean|Seba|Sek|Semion|Sen|Shagan|Shaurya|Shasha|Shayak|Shayan|Shai|Shi|Shichao|Shirine|Shishira|Shujon|Soomin|Sun|Suman|Suranjana|Suren|Sunita|Taha|Taman|Tanaya|Tapani|Teresa|Tarasha|\
Udana|Wa[hi]|Yan|Yake|Yani|Yanrui|Yahya|Yangyu|Yao|Yaochu|Yasaman|Yohan|Yuanbiao|Yue|Yuhan|Yumin|Yun|Yunji|Yunmo|Yuru|Yunhao|Zarena|Zarana|Zerui|Zeyu)"
        self.snjpfpat="\
(Aakanksha|Achan|Acharya|Arora|Ahuja|Aksak|Akshara|Amani|Amini|Aminzadeh|Amit|Amin|Aneke|Antebi|Aran|Ari|Ariyanto|Aryan|\
Ba|Baka|Badea|Basu|Bianchini|Bilen|Bahadori|Bandara|Bauza|Bedayat|Ben|Bennett|Benton|Benjamin|Benson|Bera|Bian|Bianchi|Bin|Birant|Biton|Bok|Boneh|Bouma|Bouman|Bui|Chai|Cho[ou]|Ch[iu]|Chiu|Chikina|Chien|\
Dagan|Desai|Dami[ae]n|Damak|Damaine|Dewan|Do|Dorent|Doshi|Eak|Egiazarian|Emara|Emonet|Erat|Esen|Gat|Gia|Gini|Gianchandani|Gu|Guha|Guhan|Guedon|\
...
Ochoa|Oh|Ohana|Omena|Oza|Pai|Pajarinen|Pan|Parekh|Pateraki|Pei|Pepik|Podee|Popa|Poranne|Pore|Poria|Potapenko|Potechin|Pu|Puri|\
R[au]|Rai|Raja|Rajan|Rajawat|Rakhsha|Ramamohanarao|Ramyaa|Ran|Rana|Rane|Rau|Raket|Rakshit|Razazadeh|Razaei|Razani|Rezaei|Rohani|Rege|Reinke|Ren|Riba|Ridao|Roh|Rouhani|Rozen|Ruta|Ruben|Ryu|\
Sabo|Sah|Sahai|Saria|Sai|Saikin|Saporito|Saenko|Saha|Sain|Saini|Saman[oi]|Samangouei|Samanta|Samara.+?|Saket|Sani|Saran|Sarawagi|Shabanian|Shah|Shakeri|Shayani|Shi|Shin|Shinn|Shou|Shoaran|\
